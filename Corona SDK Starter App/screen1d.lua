...
local textNewsTitle = display.newText("Contact Me", 0, 0, native.systemFontBold, 24)
textNewsTitle:setTextColor(0, 0, 0)
textNewsTitle.x = display.contentWidth * .1 - 50
textNewsTitle.y = display.contentHeight * .33
newsGroup:insert(textNewsTitle)     

--Upper right corner year display
--[[
...
--]]
--News body items start below

local textBigNewsTitle = display.newText("Need additional help?", 0, 0, native.systemFontBold, 24)
textBigNewsTitle:setTextColor(0, 0, 0)
textBigNewsTitle.x = display.contentWidth * .115
textBigNewsTitle.y = display.contentHeight * .45
newsGroup:insert(textBigNewsTitle)

local textBody = "The best way to ask questions about Corona SDK, coding or this app is in the Ansca Mobile forums."
...
local textStart = "This most recent version of this app will be posted in the Code Exchange"
...
textNewsBody2.y = display.contentHeight * .57
...
textMiniArrow.y = display.contentHeight * .633
