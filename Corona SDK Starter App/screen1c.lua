...
local textNewsTitle = display.newText("News item 3", 0, 0, native.systemFontBold, 24)
textNewsTitle:setTextColor(0, 0, 0)
textNewsTitle.x = display.contentWidth * .04
textNewsTitle.y = display.contentHeight * .33
newsGroup:insert(textNewsTitle)     

local textBody = "You will notice in the code we are using util.wrapped to make our text auto wrap to our specified area.\n\nYou can also use a backslash and the lowercase letter n together to create new paragraphs and spaces. Try finding this paragraph in the code to see the placement of the slash and lowercase n."
...
textNewsBody.y = display.contentHeight * .45
...
textMiniArrow.y = display.contentHeight * .587
