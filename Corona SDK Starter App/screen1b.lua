...
newsGroup:insert(bodyBackground3)
 ...
 local textDate = display.newText("Version 1.0", 0, 0, native.systemFontBold, 16)
...
local textNewsTitle = display.newText("Current Information", 0, 0, native.systemFontBold, 24)
textNewsTitle:setTextColor(0, 0, 0)
textNewsTitle.x = display.contentWidth * .10
textNewsTitle.y = display.contentHeight * .33
newsGroup:insert(textNewsTitle)     

local textBigNewsTitle = display.newText("How to use this app", 0, 0, native.systemFontBold, 24)
textBigNewsTitle:setTextColor(0, 0, 0)
textBigNewsTitle.x = display.contentWidth * .10
textBigNewsTitle.y = display.contentHeight * .45
newsGroup:insert(textBigNewsTitle)

local textBody = "This app was made using Corona SDK. You will find the best way to learn about creating or modding this app would be to read the lua files.\n\nI suggest you start with the startIntro.lua and then move on to the screen1.lua. Those are currently the most documented lua files. The lua notes are written with beginners in mind."
...
local textStart = "Begin learning about this app by opening startIntro.lua and screen1.lua in the applications directory"
...
textMiniArrow.y = display.contentHeight * .542
